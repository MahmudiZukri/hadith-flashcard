...
import 'package:hadith_flashcard/application/auth/auth_bloc.dart' as _i17;
...
import 'package:hadith_flashcard/application/password_textfield/password_textfield_bloc.dart'
    as _i13;
import 'package:hadith_flashcard/application/setting/setting_bloc.dart' as _i14;
import 'package:hadith_flashcard/application/user/user_bloc.dart' as _i16;
...
import 'package:hadith_flashcard/simple_bloc_observer.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i14.SettingBloc>(() => _i14.SettingBloc());
    gh.factory<_i15.SimpleBlocObserver>(
        () => _i15.SimpleBlocObserver(gh<_i11.Logger>()));
    gh.factory<_i16.UserBloc>(() => _i16.UserBloc());
    gh.factory<_i17.AuthBloc>(() => _i17.AuthBloc(gh<_i6.IAuthRepository>()));
    gh.factory<_i18.HadithFlashcardBloc>(
        () => _i18.HadithFlashcardBloc(gh<_i8.IHadithFlashcardRepository>()));
    gh.lazySingleton<_i19.IHadithNarratorRepository>(() =>
        _i9.HadithNarratorRepository(gh<_i10.INetworkService>(
            instanceName: 'network-hadith-flashcard')));
    gh.factory<_i20.HadithNarratorBloc>(
        () => _i20.HadithNarratorBloc(gh<_i19.IHadithNarratorRepository>()));
    return this;
  }
}
